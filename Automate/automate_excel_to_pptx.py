# GOALS
# [X] Filter multiple criteria in one Excel sheet tab (2 total)
#   - Conditions: Scattered Clouds; Dew PointC: 7; Wind Direction: West
#   - Conditions: Hazw; Dew PointC: 5; Wind Direction: Calm
# [X] Generate PPT slides with required information
# [X] Save information into a premade PowerPoint Template
...
path = 'C:\\Users\\12103\\Documents\\Python\\Projects\\Automate\\weather6.xlsx'

prs = Presentation(
    'C:\\Users\\12103\\Documents\\Python\\Projects\\Automate\\automate_template.pptx')
...
def createTable(dataframe, slideTitle):
    ...
    prs.save(
        'C:\\Users\\12103\\Documents\\Python\\Projects\\Automate\\Automated Weather Report.pptx')
